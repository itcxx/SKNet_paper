...
class ResNet_SKACOT(nn.Module):
    def __init__(self, depth=50,in_channels=3, out_channels=21, channel=2048, kernels=(1, 3, 5, 7), kernel_size=3):
        super().__init__()
...
#     model = ResNet_SKACOT(depth=50,in_channels=6, channel=2048, out_channels=628)
#     print(model)
